...
<head>
	...
	<link rel="stylesheet" href="{$WEBPATH}themes/{$THEMENAME}/css/red-login.css">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="login-bottom-links">
				...
				<a href="https://www.higen.net.id" style="text-decoration: none;" target='_blank'>Higen</a> is licensed under <a href="http://www.opensource.org/licenses/gpl-license.php" style="text-decoration: none;" target='_blank'>GPL</a>. 2006 - {$currentyear}.</div>
