...
<html>
    ...
    <link rel="stylesheet" href="{$WEBPATH}themes/{$THEMENAME}/css/red.css">
    ...
    <div class="page-container">
        ...
        <footer class="main" style="margin-left:16px;">
            <a href="https://www.higen.net.id" style="color: #444; text-decoration: none;" target='_blank'>Higen</a> is licensed under <a href="http://www.opensource.org/licenses/gpl-license.php" target='_blank' style="color: #445; text-decoration: none;" >GPL</a>. 2006 - {$currentyear}.
        </footer>
