...
<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" <?php echo $styleBody; ?> >
  ...
  <div/>
  <br /><br />
  <div align="center" class="copyright"><a href="https://wwww.higen.net.id" target='_blank'>Higen</a> is licensed under <a href="http://www.opensource.org/licenses/gpl-license.php" target='_blank'>GPL</a>. 2006 - <?php echo $currentYear; ?>.</div>
  <br />
</body>
</html>
