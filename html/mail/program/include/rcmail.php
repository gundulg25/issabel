...
class rcmail
{
  ...
  public function kill_session()
  {
    ...
    if (!isset($_SESSION['issabel_user']))
       ...
       foreach (array( 'temp', 'user_id', 'username', 'imap_host',
                   'imap_port', 'imap_ssl', 'password', 'login_time',
                   'mbox', 'sort_col', 'sort_order', 'quota_display') as $k)
           unset($_SESSION[$k]);
    }
  ...
  public static function setcookie($name, $value, $exp = 0)
  {
    ...
    setcookie($_SESSION['issabelSession'], $name, $value, $exp, $cookie['path'], $cookie['domain'],
