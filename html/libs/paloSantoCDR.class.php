...
SQL_COND_EXTENSION;
    ...
    function listarCDRs($param,$limit = NULL, $offset = 0)
    {
        ...
        $sPeticionSQL = 
            'SELECT calldate, src, dst, channel, dstchannel, disposition, '.'uniqueid, duration, billsec, accountcode, grpnum, description, recordingfile, cnum, cnam, outbound_cnum, did, hangup_cause, rtpqos_audio_all '.
            'FROM cdr '.
            'LEFT JOIN asterisk.ringgroups '.
                'ON asteriskcdrdb.cdr.dst = asterisk.ringgroups.grpnum '.
            $sWhere.
